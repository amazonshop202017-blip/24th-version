...
import { BarChart2, Calendar, TrendingUp, LayoutGrid, GitCompare } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      >
        {activeMainTab === 'overview' ? (
          ...
          // Wins vs Losses page - placeholder for now
          <div className="glass-card rounded-2xl p-12 flex flex-col items-center justify-center min-h-[400px]">
            <div className="w-20 h-20 rounded-2xl bg-primary/10 flex items-center justify-center mb-6">
              <TrendingUp className="w-10 h-10 text-primary" />
            </div>
            <h3 className="text-2xl font-semibold mb-3">Wins vs Losses</h3>
            <p className="text-muted-foreground text-center max-w-md">
              Detailed wins vs losses analysis and insights will be displayed here.
            </p>
          </div>
        ) : (
          <div className="glass-card rounded-2xl p-12 flex flex-col items-center justify-center min-h-[400px]">
